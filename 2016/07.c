...
// But what we need to do is whenever we encounter an ABA, search forward for a
// matching BAB inside square brackets and then bail
...
int main() {
    ...
    read_input_file(input, 256 * 1024, "07.txt");
